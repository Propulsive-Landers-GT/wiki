# Script for N2O/Paraffin + ABS

This script runs a NASA CEA O/F sweep for N2O/Paraffin + ABS.
...
OX_NAME = "N2O"
FUEL_NAME = "90 wt% Paraffin Wax / 10 wt% ABS"
...
def build_input_text(pc_bar: float, of_ratio: float, pressure_ratio: float) -> str:
  ...
  pi/p={pressure_ratio}
reactants
  fuel=Paraffin wt%=90 t(k)={PW_TEMP_K} h,cal/mol=-444600 C 73 H 124
  fuel=ABS wt%=10 t(k)={ABS_TEMP_K} h,cal/mol=14969 C 3.85 H 4.85 N 0.43
  oxid=N2O wt%=100 t(k)={N2O_TEMP_K}
output siunits
end
"""
